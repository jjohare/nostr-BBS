...
(async () => {
  ...
  await page.goto('http://localhost:4950/fairfield-nostr/', { waitUntil: 'networkidle' });
  ...
  await page.goto('http://localhost:4950/fairfield-nostr/events', { waitUntil: 'networkidle' });
  await page.waitForTimeout(2000);
  ...
  await page.goto('http://localhost:4950/fairfield-nostr/admin/calendar', { waitUntil: 'networkidle' });
  await page.waitForTimeout(2000);
  ...
  await page.goto('http://localhost:4950/fairfield-nostr/admin', { waitUntil: 'networkidle' });
  await page.waitForTimeout(2000);
  ...
  await page.goto('http://localhost:4950/fairfield-nostr/chat', { waitUntil: 'networkidle' });
  await page.waitForTimeout(2000);
